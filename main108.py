...
# Fetch and print current wallet balances dynamically based on parameters
params = load_parameters()
coin = params.get("coin")
pair = params.get("pair")
product_id = f"{coin}-{pair}"
wallet = {
    "coin": client.get_account(coin)["balance"] if coin else 0,
    "pair": client.get_account(pair)["balance"] if pair else 0
}
