...
# Fetch and print current wallet balances
wallet = {
    "coin": client.get_account("GIGA")["balance"],  # Fetch GIGA balance from Coinbase
    "pair": client.get_account("USDC")["balance"]   # Fetch USDC balance from Coinbase
}
print(f"Current wallet balances: {wallet}")  # Added this debug print
