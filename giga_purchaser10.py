...
BASE_URL = "https://api.pro.coinbase.com"  # Assuming Coinbase Pro endpoint for now

# Helper to generate the Coinbase API signature
...
def place_giga_buy_order(size):
    try:
        ...
        # Proper payload for Coinbase API (with price and size specified)
        body = {
            "product_id": "GIGA-USDC",
            "side": "buy", 
            "price": "1.00",  # Ensure the price is defined
            "size": size,  # Set the size to 1.00 for $1 GIGA-USDC purchase
